...
def parse_opts():
    ...
    parser.add_argument(
        '--datadir',
        default='/basket/Biopoint/Data/data/Biopoint/h5_2c_win7',
        type=str,
        help='Directory path of the data')
    parser.add_argument(
        '--MAT_dir',
        default= '/basket/Biopoint_3DConv_Classification_pytorch/MAT',
        type = str,
        help = 'Directory path of subjects ID'
    )
    parser.add_argument(
        '--csv_dir',
        default= '/basket/Biopoint_3DConv_Classification_pytorch/MAT/biopoint_subs.csv',
        type = str,
        help = 'Directory path of subjects ID'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--result_path',
        default='/basket/Biopoint_3DConv_Classification_pytorch/results_win7',
        type=str,
    ...
    parser.add_argument(
        '--nb_filter',
        default= [16,32,64,128, 16],#[16,32,64,128],
        type=list,
    ...
    parser.add_argument('--splits', default = 'fold_split_rep_5.h5', type = str, help =' split methods')
